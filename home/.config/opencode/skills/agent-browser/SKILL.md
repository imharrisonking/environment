...
**Note:** The default screenshot location is `/run/user/1000/agent-browser/tmp/screenshots/`. Agents with appropriate read permissions can access screenshots saved to the temp directory.
