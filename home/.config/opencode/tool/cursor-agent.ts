// Cursor Agent tool - calls external cursor-agent CLI for deep research
...
export const ask = tool({
  description:
    "Call cursor-agent CLI for deep research, a second opinion, or help fixing a bug. " +
    "Pass all relevant context including your current findings and problem you're trying to solve. " +
