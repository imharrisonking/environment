return {
    ...
    },
    {
        ...
        config = function()
            ...
            vim.opt.guicursor =
                'n-v-c:block-Cursor/lCursor,i-ci-ve:ver25-Cursor/lCursor,r-cr:hor20-Cursor/lCursor,o:hor50-Cursor/lCursor,a:blinkwait700-blinkoff400-blinkon250-Cursor/lCursor,sm:block-Cursor/lCursor'
        end,
    },
}
