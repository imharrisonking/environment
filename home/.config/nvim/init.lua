...
-- Tab settings (override the config/options.lua defaults if needed)
vim.o.tabstop = 4
vim.o.shiftwidth = 4
...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      -- Mason and related tools will be loaded from custom plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        -- YAML support (for docker-compose.yml files)
        yamlls = {
          settings = {
            yaml = {
              schemas = {
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettier', -- Used to format JS/TS/HTML/CSS/YAML code
        'gofumpt', -- Go formatter
        'goimports', -- Go imports formatter
        'hadolint', -- Dockerfile linter/formatter
      })
  ...
  -- require 'kickstart.plugins.neo-tree', -- Replaced with snacks explorer
